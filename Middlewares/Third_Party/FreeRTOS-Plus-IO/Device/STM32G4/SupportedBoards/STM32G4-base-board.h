...
#ifndef STM32G4_BASE_BOARD_H
#define STM32G4_BASE_BOARD_H
...
/*******************************************************************************
 * Map the FreeRTOS+IO interface to the STM32G4 specific functions.
 ******************************************************************************/
...
#define boardFreeRTOS_PopulateFunctionPointers vFreeRTOS_Stm32G4_PopulateFunctionPointers
...
#define boardNUM_UARTS				5 /* UART1 to UART6. */
 ...
 ******************************************************************************/
#define boardCOMMAND_CONSOLE_UART	( const int8_t * const ) "/LPUART1/"
